# Contributing to mtl-mailchimp-mcp
...
1. Check existing [issues](https://github.com/musictechlab/mtl-mailchimp-mcp/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-mailchimp-mcp/discussions)
